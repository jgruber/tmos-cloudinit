...
# constants
OUT_DIR = '/config/cloud/tmos_dhcpv4_tmm'
                    ...
                    if s_ip:
                        ...
                        if s_gw and s_gw != m_gw:
                            ...
                            if default_route_interface == links[tmm_interface_name]['interface']:
                                log_progress(
                                    'default_route_interface discovered with DHCPv4 as interface: %s gw: %s' % (links[tmm_interface_name]['interface'], s_gw))
                                route['use_rd'] = False
                                number_of_default_routes += 1
                            if configsync_interface == links[tmm_interface_name]['interface']:
                                log_progress(
                                    'configsync_interface discovered with DHCPv4 as link: ' + tmm_interface_name)
                                route['use_rd'] = False
                            ...
                            if (not default_route_interface) and (number_of_default_routes == 0 and inject_route):
                                log_progress(
                                    'dynamically setting default_route_interface with DHCPv4 interface: %s gw: %s' % (links[tmm_interface_name]['interface'], s_gw))
                                route['use_rd'] = False
