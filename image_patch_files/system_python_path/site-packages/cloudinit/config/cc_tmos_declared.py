...
def onboard(do_declaration, as3_declaration, post_onboard_enabled,
            post_onboard_commands, phone_home_url, phone_home_cli):
    ...
    if enabled:
        ...
        try:
            onboard(do_declaration, as3_declaration,
                    post_onboard_enabled, post_onboard_commands,
