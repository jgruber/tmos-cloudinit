...
def onboard(icontrollx_package_urls, do_enabled, as3_enabled, post_onboard_enabled):
    ...
    for ext_url in icontrollx_package_urls:
        try:
            ...
            parsed_url = urlparse.urlparse(ext_url)
            ...
            LOG.error("could not download: %s - %s", ext_url, err)
    ...
    if as3_enabled:
        if non_do_onboard:
            ...
            if injected_already == '0':
                LOG.info('injecting f5-appsrvs-3 delayed deployment script %s into /config/startup',
                         deploy_script_name)
